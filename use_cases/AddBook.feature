...
Scenario: Add a book with valid signature when the administrator is logged in
Given The administrator has logged in
When admin add book with Title "What If?" and Author "Randall Munroe"  and valid Signature "Munroe2014"  and ISBN "0544272641" 
Then the book will be added
